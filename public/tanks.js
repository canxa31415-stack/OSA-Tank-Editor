...
Class.barricade = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.minigun, { range: 0.5, reload: 0.6 }]),
                TYPE: "trap",
                STAT_CALCULATOR: "trap",
            },
        },
...
Class.auto3 = makeRadialAuto("autoTankGun", {isTurret: true, danger: 6, label: "Auto-3",  extraStats: {recoil:0.5}})
...
// Auto-3 upgrades
Class.auto5 = makeRadialAuto("autoTankGun", {isTurret: true, danger: 7, label: "Auto-5", count: 5, extraStats: {recoil:0.5}})
Class.mega3 = makeRadialAuto("megaAutoTankGun", {isTurret: true, danger: 7, size: 14, label: "Mega-3", body: {SPEED: 0.95 * base.SPEED}, extraStats: {reload:2}})
    ...
    ON: [
        {
            event: "tick",
            handler: ({ body }) => {
                if (body.skill.rld > 16 && body.control.fire) {
                    body.kill()
                }
            }
        }
