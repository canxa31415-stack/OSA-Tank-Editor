const g = {
// Bases
    basic: { reload: 10.5, recoil: 1.4, shudder: 0.1, damage: 0.75, speed: 4.5, spray: 15, offsetYRotated:0, offsetXRotated:0 },
    ...
    swarm: { reload: 20, recoil: 0.25, shudder: 0.05, size: 0.4, damage: 0.75, health:1.2, pen:1.1, speed: 3.9, maxSpeed:1.1, spray: 5 },
    factory: { reload: 48, shudder: 0.1, size: 0.7, damage: 0.75, speed: 3, spray: 0.1, maxSpeed: 0.5 },
...
// Snipers
    ...
    hunter: { reload: 1.5, recoil: 0.7, size: 0.95, damage: 0.9, speed: 1.1, maxSpeed: 0.8, density: 1.2, resist: 1.15, pen:0.87 },
