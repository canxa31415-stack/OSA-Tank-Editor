...
Class.radialAutoTest = makeRadialAuto("gunner", {
    count: 5,
    isTurret: false,extraStats
        : {spray: 4, speed: 1.4, maxSpeed: 1.4, recoil: 0.2},
...
Class.literallyAMachineGun = {
    ...
    UPGRADE_TOOLTIP: "[DEV NOTE] This tank does not function. Period.",
    TURRETS: [
        {
